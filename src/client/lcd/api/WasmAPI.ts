...
export class WasmAPI extends BaseAPI {
  ...
  public async codeInfo(
    ...
    if (this.lcd.config.isClassic) {
      const endpoint = `/paloma/wasm/v1beta1/codes/${codeID}`;
      return this.c
  ...
  public async contractInfo(
    ...
    if (this.lcd.config.isClassic) {
      const endpoint = `/paloma/wasm/v1beta1/contracts/${contractAddress}`;
      return this.c
  ...
  public async contractQuery<T>(
    ...
    if (this.lcd.config.isClassic) {
      const endpoint = `/paloma/wasm/v1beta1/contracts/${contractAddress}/store`;
      return this.c
  ...
  public async parameters(params: APIParams = {}): Promise<WasmParams> {
    ...
    return this.c
      .get<{ params: WasmParams.Data }>(`/paloma/wasm/v1beta1/params`, params)
      .then(({ params: d }) => ({
