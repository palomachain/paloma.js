...
const instantiateContractTxAmino = {
  ...
  raw_log:
    '[{"msg_index":0,"log":"","events":[{"type":"instantiate_contract","attributes":[{"key":"owner","value":"paloma1t72mplryz3n2y953w44fc3rj0yp4m82qvkhrz3"},{"key":"code_id","value":"118"},{"key":"contract_address","value":"paloma1emf0rwa3nfljdn6mq0mycy8vxcdaklgmzwam2s"}]},{"type":"message","attributes":[{"key":"action","value":"instantiate_contract"},{"key":"module","value":"wasm"}]}]}]',
  logs: [
    {
      msg_index: 0,
      log: '',
      events: [
        {
          ...
          attributes: [
            {
              key: 'creator',
              value: 'paloma1t72mplryz3n2y953w44fc3rj0yp4m82qvkhrz3',
            },
            {
              key: 'admin',
              value: '',
            ...
            },
            {
              ...
              value: 'paloma1emf0rwa3nfljdn6mq0mycy8vxcdaklgmzwam2s',
            },
          ],
        },
        {
  ...
  tx: {
    ...
    body: {
      messages: [
        {
          ...
          feeder: 'paloma1fa0trn2nqjc2n6mmz9txta7ky5h5nnp9m6cra3',
          validator: 'palomavaloper1vk20anceu6h9s00d27pjlvslz3avetkvnwmr35',
        },
        {
      ...
      memo: '@paloma-money/oracle-feeder@1.4.6',
      timeout_height: '0',
      extension_options: [],
...
describe('TxInfo', () => {
  ...
  it('parses events correctly', () => {
    ...
    expect({
      ...
      module: 'wasm',
      creator: 'paloma1t72mplryz3n2y953w44fc3rj0yp4m82qvkhrz3',
      admin: '',
      code_id: '118',
      contract_address: 'paloma1emf0rwa3nfljdn6mq0mycy8vxcdaklgmzwam2s',
    });
  });
});
