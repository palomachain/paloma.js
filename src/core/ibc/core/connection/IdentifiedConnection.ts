import { IdentifiedConnection as IdentifiedConnection_pb } from '@palomachain/paloma.proto/ibc/core/connection/v1/connection';
...
import {
  ...
  stateFromJSON,
  stateToJSON,
} from '@palomachain/paloma.proto/ibc/core/connection/v1/connection';
